...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم رفعه مالك اساسي .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ تم رفعه مالك اساسي .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم رفعه مالك اساسي .")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم تنزيله من رتبة المالك الاساسي .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ تم تنزيله من رتبة المالك الاساسي .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم تنزيله من رتبة المالك الاساسي .")  
return false
end
end,nil)   
end
...
Reply_Status(msg,userid,"reply","◈︙ تم تنزيله من رتبة المالك .")  
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم تنزيله من رتبة نائب المدير .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ تم تنزيله من رتبة نائب المدير .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم تنزيله من رتبة نائب المدير .")  
return false
end
...
if Alexrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ العضو : ["..result.title_.."](t.me/"..(text1[3] or "SourceDilar")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."Alex:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "SourceDilar")
send(msg.chat_id_, msg.id_,"◈︙ تم رفع مالك الكروب : ["..b.first_name_.."](T.me/"..UserName..")")  
