...
- Hi Bro in Dilar Source .
- Source Channels => @GGI55 & @GGI55 & @GGI55 & @GGI55 .
- Written BY => @GGI55 & @IIIZIIII .
]].."\27[m")
...
if database:get(bot_id.."IIIZIIII:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
...
database:setex(bot_id..'IIIZIIII:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
