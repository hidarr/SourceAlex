...
- Source Channels => @SourceDilar & @SourceDilar & @SourceDilar & @SourceDilar .
- Written BY => @iiiziiii & @UY4Bot .
]].."\27[m")
...
var = "المالك"
elseif database:sismember(bot_id.."Alex:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Alex:BasicConstructor:Rd"..chat_id) or "المالك اساسي"
elseif database:sismember(bot_id.."Alex:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Constructor:Rd"..chat_id) or "المالك"  
elseif database:sismember(bot_id.."Alex:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Alex:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Alex:Mod:Rd"..chat_id) or "نائب مدير "  
elseif database:sismember(bot_id.."Alex:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."Alex:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."Alex:Memp:Rd"..chat_id) or "الحلو"
end  
return var
end 
...
send(msg.chat_id_, msg.id_,"◈︙ تم الاذاعة الى : "..#list.." قروب .")     
database:del(bot_id.."Alex:Alex:Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
send(msg.chat_id_, msg.id_,"◈︙ معندي صلاحية تغيير معلومات القروب .") 
database:del(bot_id.."Alex:Change:Chat:Photo"..msg.chat_id_..":"..msg.sender_user_id_) 
else
...
send(msg.chat_id_,msg.id_,"◈︙ تم حفظ رابط القروب .")       
database:del(bot_id.."Alex:Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_, msg.id_,"◈︙ تم ارسال الاذاعة الى : "..#list.." قروب .")     
database:del(bot_id.."Alex:Alex:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
Reply_Status(msg,msg.sender_user_id_,"lock","◈︙ ابشر قفلت اضافة الاعضاء .")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","◈︙ ابشر قفلت الدخول الاعضاء .")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","◈︙ ابشر قفلت البوتات .")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lockkick","◈︙ ابشر قفلت البوتات بالطرد .")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","◈︙ ابشر تم قفل الكل .")  
return false
end 
...
Reply_Status(msg,msg.sender_user_id_,"lock","◈︙ ابشر قفلت الفارسية .")  
end
...
Reply_Status(msg,msg.sender_user_id_,"lockkid","◈︙ ابشر قفلت المتحركة بالتقييد .")  
return false
end 
if text == "قفل المتحركة بالكتم" and Addictive(msg) then
database:set(bot_id.."Alex:Lock:Animation"..msg.chat_id_,"ktm")  
Reply_Status(msg,msg.sender_user_id_,"lockktm","◈︙ ابشر قفلت المتحركة بالكتم .")  
return false
end 
if text == "قفل المتحركة بالطرد" and Addictive(msg) then
database:set(bot_id.."Alex:Lock:Animation"..msg.chat_id_,"kick")  
Reply_Status(msg,msg.sender_user_id_,"lockkick","◈︙ ابشر قفلت المتحركة بالطرد .")  
return false
end 
...
if text == "مسح المالكين الاساسيين" and DevBot(msg) then
...
send(msg.chat_id_, msg.id_, "◈︙ تم مسح نائبين المدراء .")
end
...
send(msg.chat_id_, msg.id_, "◈︙ مافيه احد مكتوم عشان امسحه .")
end
...
if text == "المالكين الاساسيين" and DevBot(msg) then
...
if text == ("رفع M") and tonumber(msg.reply_to_message_id_) ~= 0 and DevAlex(msg) then
function Function_Alex(extra, result, success)
database:sadd(bot_id.."Alex:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم رفعه M .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false 
end
if text and text:match("^رفع M @(.*)$") and DevAlex(msg) then
...
Reply_Status(msg,result.id_,"reply","◈︙ تم رفعه M .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
if text and text:match("^رفع M (%d+)$") and DevAlex(msg) then
local userid = text:match("^رفع M (%d+)$")
database:sadd(bot_id.."Alex:Sudo:User", userid)
Reply_Status(msg,userid,"reply","◈︙ تم رفعه M .")  
return false 
end
if text == ("تنزيل M") and tonumber(msg.reply_to_message_id_) ~= 0 and DevAlex(msg) then
function Function_Alex(extra, result, success)
database:srem(bot_id.."Alex:Sudo:User", result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم حذفه من قائمة M .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false 
end
if text and text:match("^تنزيل M @(.*)$") and DevAlex(msg) then
local username = text:match("^تنزيل M @(.*)$")
function Function_Alex(extra, result, success)
if result.id_ then
database:srem(bot_id.."Alex:Sudo:User", result.id_)
Reply_Status(msg,result.id_,"reply","◈︙ تم حذفه من قائمة M .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,result.id_,"reply","◈︙ نزلته من المالك .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ رفعته صار مالك .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ رفعته صار مالك .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ رفعته صار مالك اساسي .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ رفعته صار مالك اساسي .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ رفعته صار مالك اساسي .")  
return false
end
end,nil)   
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ نزلته من المالك الاساسي .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ نزلته من المالك الاساسي .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ نزلته من المالك الاساسي .")  
return false
end
end,nil)   
end
...
Reply_Status(msg,userid,"reply","◈︙ رفعته صار مالك .")  
end
...
Reply_Status(msg,userid,"reply","◈︙ نزلته من المالك .")  
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ رفعته صار مدير .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end  
...
Reply_Status(msg,result.id_,"reply","◈︙ رفعته صار مدير .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ رفعته صار مدير .")  
return false
end  
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ نزلته من المدير .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end  
...
Reply_Status(msg,result.id_,"reply","◈︙ نزلته من المدير .")  
else
...
Reply_Status(msg,userid,"reply","◈︙ نزلته من المدير .")  
return false
end
...
send(msg.chat_id_, msg.id_,'◈︙ الرفع معطل من قبل المالكين حبيبي .')
return false
end
function Function_Alex(extra, result, success)
database:sadd(bot_id.."Alex:Mod:User"..msg.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ رفعته صار نائب مدير .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ رفعته صار نائب مدير .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
if text and text:match("^رفع نائب مدير (%d+)$") and Owner(msg) then 
local res = https.request('https://dilar.ml/hidar.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'◈︙ اشترك بقناة السورس وارجع دز الامر عمري .\n◈︙ قناة السورس : @SourceDilar .')   
...
if not Constructor(msg) and database:get(bot_id.."Add:Group:Cheking"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'◈︙ الرفع معطل من المالكين حبيبي .')
return false
end
database:sadd(bot_id.."Alex:Mod:User"..msg.chat_id_, userid)
Reply_Status(msg,userid,"reply","◈︙ رفعته صار نائب مدير .")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ نزلته من نائب المدير .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ نزلته من نائب المدير .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
if text and text:match("^تنزيل نائب مدير (%d+)$") and Owner(msg) then 
local res = https.request('https://dilar.ml/hidar.php?id='..msg.sender_user_id_)
if res then
if res == 'false' then
send(msg.chat_id_,msg.id_,'◈︙ اشترك بقناة السورس وارجع دز الامر عمري .\n◈︙ قناة السورس : @SourceDilar .')   
...
Reply_Status(msg,userid,"reply","◈︙ نزلته من نائب المدير .")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ رفعته صار مميز .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ رفعته صار مميز .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ رفعته صار مميز .")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ نزلته من المميز .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ نزلته من المميز .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ نزلته من المميز .")  
return false
end  
...
if Alexrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n◈︙ الحلو : ["..result.title_.."](t.me/"..(text1[3] or "SourceDilar")..")".."\n◈︙ تم رفعه : "..text1[2].." هنا .")   
database:sadd(bot_id.."Alex:Special:User"..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'◈︙ الحظر معطل من المالكين قلبي .')
return false
end
function Function_Alex(extra, result, success)
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم الغاء حظره من القروب .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ تم الغاء حظره من القروب .")  
else
send(msg.chat_id_, msg.id_, "◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم الغاء حظره من القروب .")  
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم كتمه بالقروب .")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
end
...
Reply_Status(msg,result.id_,"reply","◈︙ تم كتمه بالقروب .")  
else
send(msg.chat_id_, msg.id_, "◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم كتمه بالقروب .")  
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم تقييده بالقروب .")  
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
return false
...
Reply_Status(msg,result.id_,"reply","◈︙ تم تقييده بالقروب .")  
else
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد حساب بهذا المعرف .")
end
end
...
Reply_Status(msg,userid,"reply","◈︙ تم تقييده بالقروب .")  
end
return false
end
...
if not Constructor(msg) and database:get(bot_id.."Ban:Cheking"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'◈︙ الطرد معطل من المالكين عمري .')
return false
end
function Function_Alex(extra, result, success)
if Rank_Checking(result.sender_user_id_, msg.chat_id_) == true then
...
Kick_Group(result.chat_id_, result.sender_user_id_)
Reply_Status(msg,result.sender_user_id_,"reply","◈︙ تم طرده من القروب .")  
end,nil)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Alex, nil)
...
Kick_Group(msg.chat_id_, result.id_)
Reply_Status(msg,result.id_,"reply","◈︙ تم طرده من القروب .")  
end,nil)   
end
else
send(msg.chat_id_, msg.id_, "◈︙ لا يوجد حساب بهذا المعرف .")
...
send(msg.chat_id_, msg.id_, '◈︙ ابشر عطلت الحظر والطرد .')
return false
end
end
...
send(msg.chat_id_, msg.id_, '◈︙ ابشر فعلت الحظر والطرد .')
return false
end
end
...
send(msg.chat_id_, msg.id_, '◈︙ تم تعطيل رفع نائبين المدراء والاعضاء المميزين .')
return false
end
end
...
send(msg.chat_id_, msg.id_, '◈︙ تم تفعيل رفع نائبين المدراء والاعضاء المميزين .')
return false
end
end
...
send(msg.chat_id_,msg.id_,"◈︙ التثبيت معطل من المالكين عمري .")  
return false  
end
...
if database:sismember(bot_id.."Alex:Lock:pin",msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_,"◈︙ الغاء التثبيت معطل من المالكين عمري .")  
return false  
end
...
if link then                              
send(msg.chat_id_,msg.id_,"◈︙ رابط القروب .\n ["..link.."]")                          
else                
...
send(msg.chat_id_, msg.id_,"◈︙ تم حذف صورة القروب .") 
end
return false  
end
...
Welcome = "◈︙ لم يتم وضع ترحيب للقروب ."
end 
...
send(msg.chat_id_, msg.id_,'◈︙ ابشر مسحت قائمة المتحركات الممنوعة .')  
end
if text == 'مسح الصور الممنوعة' and Owner(msg) then     
database:del(bot_id.."filterphoto"..msg.chat_id_)
send(msg.chat_id_, msg.id_,'◈︙ ابشر مسحت قائمة الستكرات الممنوعة .')  
end
...
send(msg.chat_id_, msg.id_,"◈︙ ابشر مسحت قائمة المنع .")  
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "◈︙ ماكو بوتات بالقروب .")
else
...
if Addictive(msg) then
send(msg.chat_id_, msg.id_,"◈︙ تم مسح قوانين القروب .")  
...
if text and text:match("^تغيير رد نائب مدير  (.*)$") and Owner(msg) then
local Teext = text:match("^تغيير رد نائب مدير  (.*)$") 
database:set(bot_id.."Alex:Mod:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◈︙ تم تغيير رد نائب مدير  الى : "..Teext)
end
...
if text and text:match("^تغيير رد الحلو (.*)$") and Owner(msg) then
local Teext = text:match("^تغيير رد الحلو (.*)$") 
database:set(bot_id.."Alex:Memp:Rd"..msg.chat_id_,Teext)
send(msg.chat_id_, msg.id_,"◈︙ تم تغيير رد الحلو الى : "..Teext)
end
...
send(msg.chat_id_, msg.id_,"◈︙ ابشر مسحت ردود المدير .")
end
...
send(msg.chat_id_, msg.id_,"◈︙ ابشر مسحت ردود المطور .")
end
...
send(msg.chat_id_, msg.id_,'◈︙ ابشر طردد الحسابات المحذوفة .')
end,nil)
end
end
...
local BROK = "◈︙ عدد نائبين المدراء : "..data.administrator_count_..
...
send(msg.chat_id_, msg.id_,"◈︙ لا يمكنني طرد نائبين المدراء .") 
return false  
end
...
send(msg.chat_id_, msg.id_,"◈︙ الامر معطل من المالكين عمري .") 
end
end
...
if text ==("رفع نائبين المدراء") and Owner(msg) then
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"◈︙ لا يوجد نائبين المدراء .") 
else
send(msg.chat_id_, msg.id_,"◈︙ تم رفع : { "..num2.." } من ادمنية القروب .") 
end
end,nil)   
end
if text ==("المالك") then
...
if b.first_name_ == false then
send(msg.chat_id_, msg.id_,"◈︙ المالك محذوف .")
return false  
end
local UserName = (b.username_ or "SourceDilar")
...
local UserName = (b.username_ or "SourceDilar")
send(msg.chat_id_, msg.id_,"◈︙ تم رفع مالك القروب : ["..b.first_name_.."](T.me/"..UserName..")")  
...
send(msg.chat_id_, msg.id_,"◈︙ تم مغادرة القروب .") 
send(GP_ID[2], 0,"◈︙ تم مغادرة القروب بأمر من المطور .") 
...
if text == (database:get(bot_id.."Alex:Name:Bot") or "ديلار") then
Namebot = (database:get(bot_id.."Alex:Name:Bot") or "ديلار")
local namebot = {
"يا حبيب "..Namebot.. " كول",
"ها عمري اني "..Namebot,
'لبيه يـ قلبها.',
...
send(msg.chat_id_, msg.id_, '◈︙ ابشر مسحت الايدي .')
end
return false  
end 
...
send(msg.chat_id_, msg.id_,'◈︙ ابشر قفلت التظيف .') 
end
...
if text == "تنظيف القروبات" and DevAlex(msg) then
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'◈︙ لا يوجد قروبات وهمية .')   
else
local BROK = (w + q)
...
x_BRK = '\n◈︙ تم حذف : '..w..' قروب لان البوت عضو .'
end
send(msg.chat_id_, msg.id_,'◈︙ عدد القروبات : '..#group..' .'..x_BRK..''..BROK..'\n◈︙ عدد القروبات الان : '..sendok..' .\n')   
end
end
end,nil)
end
...
File:write(t)
File:close()
sendDocument(msg.chat_id_, msg.id_,'./File_Libs/'..bot_id..'.json', '◈︙ عدد قروبات البوت : { '..#list..'} .')
end
...
if DevAlex(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SorceLink/SourceAlex/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/SorceLink/SourceAlex/master/"..file)
if res == 200 then
os.execute("rm -fr Alex_Files/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SourceDilar.lua')  
else
...
{
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
},
{
{text = '- Dev .', url = "https://t.me/iiiziiii"}
},
{
{text = '- MY BOT .', url = "https://t.me/UY4Bot"}
},
}
...
keyboard.inline_keyboard = {
{
{text = '- اوامر الحماية .', callback_data=msg.sender_user_id_.."/help1"},{text = '- اوامر نائبين المدراء .', callback_data=msg.sender_user_id_.."/help2"},
},
{
{text = '- اوامر المدراء .', callback_data=msg.sender_user_id_.."/help3"},
},
{
{text = '- اوامر المالكين .', callback_data=msg.sender_user_id_.."/help4"},{text = '- اوامر المطورين .', callback_data=msg.sender_user_id_.."/help5"},
},
{
...
Text = [[
    ◈︙ قائمة اوامر المالكين الاساسيين .
- - - - -
- رفع او تنزيل مالك .
- المالكين .
- مسح المالكين .
- - - - -
◈︙ قائمة اوامر المالكين .
- - - - -
- رفع او تنزيل مدير .
- المدراء .
- مسح المدراء .
...
Reply_Status(msg,result.id_,'reply_Add','◈︙ تم تفعيل البوت بقروب : '..chat.title_..' .')
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
if data.members_[i].status_.ID == "ChatMemberStatusCreator" then
...
Reply_Status(msg,result.id_,'reply_Add','◈︙ تم تفعيل القروب : '..chat.title_..'')
database:sadd(bot_id..'Alex:Chek:Groups',msg.chat_id_)  
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data) 
local admins = data.members_
for i=0 , #admins do
...
Test = '- هلا عمريي الحاتت .\n- اني بوت اختصاصي حماية القروبات من التفليش وهلأمور .\n- ارفعني بالقروب ودز تفعيل يحلو .\n- معرف Myth : ['..UserName..'] .'
end 
send(msg.chat_id_, msg.id_, Test) 
end
end
...
if text == 'حظر' then
sendText(Id_Sudo,'◈︙ الحلو : ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n◈︙ تم حظره من البوت .',msg.id_/2097152/0.5,'md')
...
function tdcli_update_callback(data)
    ...
    if Text and Text:match('(.*)/help1') and Addictive(IIIZIIII) then
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    if Text and Text:match('(.*)/help2') and Addictive(IIIZIIII) then
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    if Text and Text:match('(.*)/help3') and Owner(IIIZIIII) then
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    if Text and Text:match('(.*)/help4') and Constructor(IIIZIIII) then
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    if Text and Text:match('(.*)/help5') and DevBot(IIIZIIII) then
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    if Text and Text:match('(.*)/help') and Addictive(IIIZIIII) then
    if tonumber(Text:match('(.*)/help')) == tonumber(data.sender_user_id_) then
    local Teext =[[
◈︙م1 : اوامر الحماية .
◈︙م2 : اوامر نائبين المدراء .
◈︙م3 : اوامر المدراء .
◈︙م4 : اوامر المالكين .
◈︙م5 : اوامر المطورين .
    ]]
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    local Textedit = '• ابشر عطلت التنزيل '
    ...
    local Textedit = '• ابشر عطلت الترحيب '
    ...
    local Textedit = '• ابشر عطلت الايدي '
    ...
    local Textedit = '• ابشر عطلت الايدي بالصوره '
    ...
    local Textedit = '• ابشر عطلت الحظر '
    ...
    local Textedit = '• ابشر عطلت الرفع '
    database:set(bot_id.."Add:Group:Cheking"..Chat_id,"true")
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    ...
    local Textedit = '• ابشر عطلت اطردني '
    ...
    local Textedit = '• ابشر فعلت التنزيل '
    ...
    local Textedit = '• ابشر فعلت الترحيب '
    ...
    local Textedit = '• ابشر فعلت الايدي '
    ...
    local Textedit = '• ابشر فعلت الايدي بالصوره '
    ...
    local Textedit = '• ابشر فعلت الحظر '
    ...
    local Textedit = '• ابشر فعلت الرفع '
    database:set(bot_id.."Add:Group:Cheking"..Chat_id,"true")
    keyboard = {} 
    keyboard.inline_keyboard = {
    {
    ...
    local Textedit = '• ابشر فعلت اطردني '
...
{text = '- Source Dilar .', url = "https://t.me/SourceDilar"}
    ...
    elseif Text and Text:match('(.*)/lockchat') and Owner(IIIZIIII) then
    ...
    local Textedit = '• ابشر قفلت البوتات '
    ...
    elseif Text and Text:match('(.*)/lockedit') and Owner(IIIZIIII) then
    ...
    local Textedit = '• ابشر قفلت الروابط '
    ...
    local Textedit = '• ابشر قفلت المعرفات '
    ...
    elseif Text and Text:match('(.*)/lockusername') and Addictive(data) then
    if tonumber(Text:match('(.*)/lockusername')) == tonumber(data.sender_user_id_) then
    local Textedit = '• ابشر قفلت التاك '
    ...
    local Textedit = '• ابشر قفلت الملصقات '
    ...
    local Textedit = '• ابشر قفلت الصور '
    ...
    local Textedit = '• ابشر قفلت الاغاني '
    ...
    local Textedit = '• ابشر قفلت الصوت '
    ...
    local Textedit = '• ابشر قفلت التوجيه '
    ...
    local Textedit = '• ابشر قفلت الملفات '
    ...
    local Textedit = '• ابشر قفلت الجهات '
    ...
    local Textedit = '• ابشر قفلت الكلايش '
    ...
    local Textedit = '• ابشر قفلت التكرار '
    ...
    local Textedit = '• ابشر قفلت الانلاين '
    ...
    local Textedit = '• ابشر فتحت الكلايش '
    ...
    local Textedit = '• ابشر فتحت الانلاين '
